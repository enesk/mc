    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#!"><i class="fa fa-car"></i> <span>Autos</span> <i
                                class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                        <li><a href="{{ url('admin/cars') }}"><i class="fa fa-list"></i> <span>Alle Autos</span></a></li>
                        <li><a href="{{ url('admin/companies') }}"><i class="fa fa-list"></i> <span>Alle Marken</span></a></li>
                        <li><a href="{{ url('admin/models') }}"><i class="fa fa-list"></i> <span>Alle Modelle</span></a></li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ url('admin/backup') }}"><i class="fa fa-hdd-o"></i> <span>Backups</span></a>
                        </li>
                        <li><a href="{{ url('admin/log') }}"><i class="fa fa-terminal"></i> <span>Logs</span></a></li>
                        <li><a href="{{ url('admin/setting') }}"><i class="fa fa-cog"></i> <span>Settings</span></a>
                        </li>
                    </ul>
                </li>
