    ...
    <div class="container-fluid">
        <div class="row">
            <?php foreach(\Modules\Rental\Models\Station::all() as $station): ?>
                <a href="<?php echo e(str_slug($station->city)); ?>/sales" class="col-lg-3 col-sm-3 col-xs-6 start-locations"
            ...
            <?php endforeach; ?>
            <a href="http://www.millenniumtrucks.de/" target="_blank" class="col-lg-3 col-sm-3 col-xs-6 start-locations"
