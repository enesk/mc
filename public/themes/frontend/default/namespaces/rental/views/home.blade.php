            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-xs-12">
                        ...
                        <div class="dateSelection mt10">
                            <div class="dateWrapper">
                                ...
                                <input type="text" class="form-control formStyle thinner datepick" placeholder=""
                                       aria-describedby="from_date" id="dpd1">
                                <input type="text" class="form-control formStyle thinner timepick" placeholder=""
                                       aria-describedby="from_time" data-toggle="dropdown" id="from_time_dropdown">
                            ...
                            <div class="dateWrapper mt10">
                                ...
                                <input type="text" class="form-control formStyle thinner datepick" placeholder=""
                                       aria-describedby="to_date" id="dpd2">
                                <input type="text" class="form-control formStyle thinner timepick" placeholder=""
                                       aria-describedby="to_time" data-toggle="dropdown" id="to_time_dropdown">
                    ...
                    <div class="searchBox_action">
                        <button type="submit" name="Preis_ermitteln" class="btn btn-block">Preis ermitteln
